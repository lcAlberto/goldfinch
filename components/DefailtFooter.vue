<template>
  <footer class="footer p-10 bg-primary flex justify-center">
    <div class="py-10 w-3/5 grid md:grid-cols-2 md:h-40 justify-items-center">
      <div class="flex items-center flex-col">
        <img
            ...
            alt=""
        />
        <div class="grid grid-flow-col gap-4 text-fuchsia-800">
...
<style scoped>
footer {
  background-color: rgb(38, 0, 71);
  background-image: url("~/assets/images/quero-crescer/02.png");
